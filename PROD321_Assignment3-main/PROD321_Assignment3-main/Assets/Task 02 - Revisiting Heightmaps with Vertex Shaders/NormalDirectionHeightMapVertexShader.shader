 ...
 * shader to support height maps at a shader level. This
 * shader creates a height map by moving vertices in the
...
Shader "Assignment3/Task2/NormalDirectionHeightMapVertexShader"
{
    ...
    Properties
    {
        ...
        /*******
         * TODO: Sub task 2 Code goes here (2/4)
         *******/ 
         heightScale ("Height Scale", float) = 0.4
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct VertexIn
            {
                ...
                /*******
                 * TODO: Sub task 2 Code goes here (4/4)
                 *******/
            ...
            /*******
             * TODO: Sub task 2 Code goes here (1/4) 
             *******/
             float heightScale;
            ...
            VertexOutFragmentIn vert (VertexIn v)
            {
                ...
                /*******
                 * TODO: Sub task 2 Code goes here (3/4)
                 *******/
                 objectSpaceVertexPosition += v.normal * vertexTextureColour.r * heightScale;
